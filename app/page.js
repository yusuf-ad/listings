...
export default function Home() {
  ...
  const selectListing = (index) => {
    ...
    // Keep current active tab instead of resetting to overview
  };
  ...
  return (
    <div className="app">
      {/* Floating sidebar reopen button — visible only when sidebar is collapsed */}
      <button
        className={`sidebar-reopen-btn ${sidebarCollapsed ? "visible" : ""}`}
      ...
      <aside className={`sidebar ${sidebarCollapsed ? "collapsed" : ""} ${mobileSidebarOpen ? "mobile-open" : ""}`}>
        <div className="sidebar-header">
          <button
            className="logo logo-toggle-btn"
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            ...
            <button className="sidebar-toggle" onClick={() => setSidebarCollapsed(true)} title="Close sidebar">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
